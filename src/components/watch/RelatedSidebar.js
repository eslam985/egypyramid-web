            ...
            <div className="flex flex-row overflow-x-auto gap-4 no-scrollbar md:flex-col md:overflow-visible pb-2 touch-pan-x snap-x snap-mandatory">
                {related.map((item) => (
                    ...
                    prefetch={false}
                        ...
                        className="group flex flex-col shrink-0 w-[130px] gap-3 p-2 rounded-2xl bg-white/[0.02] border border-white/5 lg:hover:bg-white/5 md:flex-row md:w-full md:bg-transparent md:border-transparent md:hover:border-white/5 snap-start"
                    >
