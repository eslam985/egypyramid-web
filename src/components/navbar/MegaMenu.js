                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-5 gap-fluid-gap">
                    {genres.map((genre) => (
                        <Link
                            ...
                            className="group relative flex items-center sm:gap-1 sm:px-2 gap-3 px-4 py-2 bg-(--background)/50 border border-slate-200 dark:border-slate-800 rounded-xl duration-300 lg:hover:text-(--foreground) lg:hover:bg-(--accent)/10 lg:hover:border-(--accent)/20 lg:hover:-translate-y-1 no-underline overflow-hidden backdrop-blur-sm"
                        >
