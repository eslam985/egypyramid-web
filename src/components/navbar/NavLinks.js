    ...
    return (
        <div className="flex items-center gap-6">
            ...
            <Link
                prefetch={false}
                href="/"
                className="group relative py-2 text-sm font-bold text-slate-600 dark:text-slate-300 hover:text-yellow-600 dark:hover:text-yellow-500 duration-300 no-underline"
            >
                الرئيسية
            ...
            <Link
                ...
                prefetch={false}
                className="relative flex items-center gap-2 px-4 py-1.5 rounded-full bg-(--background) dark:bg-yellow-600/10 border border-yellow-500/40 dark:border-yellow-500/30 text-yellow-700 dark:text-yellow-500 font-black text-sm no-underline shadow-sm hover:scale-105 duration-300 overflow-hidden group"
            >
