  ...
  return (
    ...
    <section className="relative overflow-hidden">
      ...
      <div className="relative">
        ...
        <div className="flex items-start overflow-x-auto gap-fluid-gap no-scrollbar pb-10 pt-6 mr-3 snap-x snap-proximity">
          {series.data.map((media, index) => (
            <div
              key={media.id}
              className="flex-none w-40 md:w-52 snap-start h-fit"
            >
          ...
          <div className="flex-none w-40 md:w-52 snap-start">
            <div className="aspect-2/3 flex items-center justify-center">
              ...
              >
                ...
                <div className="w-16 h-16 rounded-full border-2 border-dashed border-(--foreground)/30 flex items-center justify-center lg:group-hover/more:border-(--accent) lg:group-hover/more:scale-105 transition-[border-color,transform] duration-200 shadow-inner">
                  <Tv
                    size={24}
                    className="text-(--foreground)/80 group-hover/more:text-(--accent)"
                  />
                </div>
