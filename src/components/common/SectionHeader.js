        ...
        <div className="group/header flex items-end justify-between mb-2 px-2 relative">
            <div className="flex items-center gap-5">
                ...
                <div className="relative group-hover/header:scale-110 transition-transform duration-500">
                    ...
                    <div className="relative w-14 h-14 rounded-2xl bg-linear-to-br from-(--accent)/20 to-transparent flex items-center justify-center text-(--accent) border border-(--accent)/20 shadow-[inset_0_0_15px_rgba(202,138,4,0.3)] group-hover/header:rotate-12 transition-all duration-500 overflow-hidden">
                ...
                <div className="space-y-1">
                    ...
                    <h2 className="text-fluid-h2 font-black text-(--foreground) tracking-tighter transition-all duration-500 group-hover/header:translate-x-2 group-hover/header:text-(--accent)">
                        {title}
                    </h2>

                    <div className="flex items-center gap-3">
                        {/* الخط الديكوري: خليته Gradient */}
                        <span className="w-8 h-[3px] bg-linear-to-r from-(--accent) to-transparent rounded-full group-hover/header:w-16 transition-all duration-500" />
            ...
            >
                ...
                <div className="relative z-10 w-8 h-8 rounded-full bg-slate-800/50 flex items-center justify-center border border-white/5 group-hover/btn:bg-(--accent) group-hover/btn:text-slate-950 group-hover/btn:rotate-[-10deg] transition-all duration-500">
