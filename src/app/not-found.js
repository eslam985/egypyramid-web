      ...
      <div className="text-center space-y-8 max-w-lg animate-fade-in-up">
        ...
        <div className="flex gap-4 justify-center flex-wrap">
          <Link
            prefetch={false}
            href="/"
            className="px-8 py-4 bg-(--accent) text-slate-950 rounded-2xl font-black text-sm uppercase tracking-widest hover:shadow-[0_20px_40px_rgba(202,138,4,0.3)] hover:-translate-y-1 transition-all no-underline"
          >
            الرئيسية
          </Link>
          <Link
            prefetch={false}
            href="/genre/movies"
            className="px-8 py-4 glass-card text-(--foreground) rounded-2xl font-black text-sm uppercase tracking-widest hover:border-(--accent)/40 hover:text-(--accent) transition-all no-underline"
          >
            تصفح الأفلام
          </Link>
        </div>
